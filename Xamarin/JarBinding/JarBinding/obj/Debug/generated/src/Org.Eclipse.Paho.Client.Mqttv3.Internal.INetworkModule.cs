...
namespace Org.Eclipse.Paho.Client.Mqttv3.Internal {
	...
	public partial interface INetworkModule : IJavaObject {
		...
		global::System.IO.Stream InputStream {
			...
			[Register ("getInputStream", "()Ljava/io/InputStream;", "GetGetInputStreamHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, JarBinding")] get;
		}
		...
		global::System.IO.Stream OutputStream {
			...
			[Register ("getOutputStream", "()Ljava/io/OutputStream;", "GetGetOutputStreamHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, JarBinding")] get;
		}
		...
		[Register ("start", "()V", "GetStartHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, JarBinding")]
		void Start ();
		...
		[Register ("stop", "()V", "GetStopHandler:Org.Eclipse.Paho.Client.Mqttv3.Internal.INetworkModuleInvoker, JarBinding")]
		void Stop ();
