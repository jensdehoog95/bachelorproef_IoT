...
namespace Org.Eclipse.Paho.Client.Mqttv3 {
	...
	public partial interface IMqttClientPersistence : IJavaObject {
		...
		[Register ("clear", "()V", "GetClearHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
		void Clear ();
		...
		[Register ("close", "()V", "GetCloseHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
		void Close ();
		...
		[Register ("containsKey", "(Ljava/lang/String;)Z", "GetContainsKey_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
		...
		[Register ("get", "(Ljava/lang/String;)Lorg/eclipse/paho/client/mqttv3/MqttPersistable;", "GetGet_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
		...
		[Register ("keys", "()Ljava/util/Enumeration;", "GetKeysHandler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
		...
		[Register ("open", "(Ljava/lang/String;Ljava/lang/String;)V", "GetOpen_Ljava_lang_String_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
		...
		[Register ("put", "(Ljava/lang/String;Lorg/eclipse/paho/client/mqttv3/MqttPersistable;)V", "GetPut_Ljava_lang_String_Lorg_eclipse_paho_client_mqttv3_MqttPersistable_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
		...
		[Register ("remove", "(Ljava/lang/String;)V", "GetRemove_Ljava_lang_String_Handler:Org.Eclipse.Paho.Client.Mqttv3.IMqttClientPersistenceInvoker, JarBinding")]
...
#pragma warning restore 0169
		...
		public unsafe bool ContainsKey (string p0)
		{
			...
			bool __ret = JNIEnv.CallBooleanMethod (Handle, id_containsKey_Ljava_lang_String_, __args);
...
#pragma warning restore 0169
		...
		public unsafe global::Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistable Get (string p0)
		{
			...
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue (native_p0);
			global::Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistable __ret = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Paho.Client.Mqttv3.IMqttPersistable> (JNIEnv.CallObjectMethod (Handle, id_get_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}
